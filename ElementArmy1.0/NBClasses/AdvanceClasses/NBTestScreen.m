...
-(void)testButtonOnSubLayer
{
    ...
    NBButton* testButton = [NBButton createWithStringHavingNormal:@"button_confirm.png" havingSelected:@"button_confirm.png" havingDisabled:@"button_confirm.png" onLayer:self selector:@selector(onTestButtonPressed) withSize:CGSizeZero onSubLayer:self.testSubLayer];
