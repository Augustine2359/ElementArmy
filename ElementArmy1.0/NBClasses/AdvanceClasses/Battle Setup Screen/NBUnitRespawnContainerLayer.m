...
//        [self addChild:labelHP];
        self.labelHPStat = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"HP: %i", statsList.currentHP] fontName:@"Marker Felt" fontSize:15];
...
//        [self addChild:labelSP];
        self.labelSPStat = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"SP %i", statsList.currentSP] fontName:@"Marker Felt" fontSize:15];
...
//        [self addChild:labelSTR];
        self.labelSPStat = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"STR: %i", statsList.currentSTR] fontName:@"Marker Felt" fontSize:15];
...
//        [self addChild:labelDEF];
        self.labelDEFStat = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"DEF: %i", statsList.currentDEF] fontName:@"Marker Felt" fontSize:15];
...
//        [self addChild:labelINT];
        self.labelINTStat = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"INT: %i", statsList.currentINT] fontName:@"Marker Felt" fontSize:15];
...
//        [self addChild:labelDEX];
        self.labelDEXStat = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"DEX: %i", statsList.currentDEX] fontName:@"Marker Felt" fontSize:15];
...
//        [self addChild:labelEVA];
        self.labelEVAStat = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"EVA: %i", statsList.currentEVA] fontName:@"Marker Felt" fontSize:15];
