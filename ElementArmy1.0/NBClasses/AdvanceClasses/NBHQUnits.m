...
-(void)initialise{
    ...
    CCLabelTTF* labelHP = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"HP: %i", statsList.currentHP] fontName:@"PF Ronda Seven" fontSize:15];
    CCLabelTTF* labelSP = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"SP: %i", statsList.currentSP] fontName:@"PF Ronda Seven" fontSize:15];
    CCLabelTTF* labelSTR = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"STR: %i", statsList.currentSTR] fontName:@"PF Ronda Seven" fontSize:15];
    CCLabelTTF* labelDEF = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"DEF: %i", statsList.currentDEF]fontName:@"PF Ronda Seven" fontSize:15];
    CCLabelTTF* labelINT = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"INT: %i", statsList.currentINT] fontName:@"PF Ronda Seven" fontSize:15];
    CCLabelTTF* labelDEX = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"DEX: %i", statsList.currentDEX] fontName:@"PF Ronda Seven" fontSize:15];
    CCLabelTTF* labelEVA = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"EVA: %i", statsList.currentEVA] fontName:@"PF Ronda Seven" fontSize:15];
